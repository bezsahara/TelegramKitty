...
abstract class KittyBot {
     ...
     */
    abstract suspend fun banChatMember(
        chatId: ChatId,
        userId: Long,
        untilDate: Long? = null,
     ...
     */
    abstract suspend fun editStory(
        businessConnectionId: String,
        storyId: Long,
     ...
     */
    abstract suspend fun setPassportDataErrors(
        userId: Long,
     ...
     */
    abstract suspend fun getUpdates(
        offset: Long? = null,
        limit: Long? = null,
        timeout: Long? = null,
     ...
     */
    abstract suspend fun copyMessages(
        chatId: ChatId,
        fromChatId: ChatId,
        messageIds: List<Long>,
        messageThreadId: Long? = null,
     ...
     */
    abstract suspend fun setStickerEmojiList(
        sticker: String,
     ...
     */
    abstract suspend fun getUserProfilePhotos(
        userId: Long,
        offset: Long? = null,
        limit: Long? = null
     ...
     */
    abstract suspend fun pinChatMessage(
        chatId: ChatId,
        messageId: Long,
        businessConnectionId: String? = null,
        disableNotification: Boolean? = null
     ...
     */
    abstract suspend fun upgradeGift(
        businessConnectionId: String,
        ownedGiftId: String,
     ...
     */
    abstract suspend fun answerInlineQuery(
     ...
     */
    abstract suspend fun sendChatAction(
        chatId: ChatId,
        action: ChatAction,
        businessConnectionId: String? = null,
        messageThreadId: Long? = null
     ...
     * @param name Invite link name; 0-32 characters
     */
    abstract suspend fun createChatSubscriptionInviteLink(
        chatId: ChatId,
     ...
     */
    abstract suspend fun answerShippingQuery(
     ...
     */
    abstract suspend fun savePreparedInlineMessage(
        userId: Long,
     ...
     */
    abstract suspend fun giftPremiumSubscription(
        userId: Long,
        monthCount: Long,
        starCount: Long,
        text: String? = null,
     ...
     */
    abstract suspend fun setWebhook(
        url: String,
     ...
     */
    abstract suspend fun postStory(
        businessConnectionId: String,
        content: InputStoryContent,
        activePeriod: Long,
        caption: String? = null,
     ...
     */
    abstract suspend fun transferGift(
        businessConnectionId: String,
        ownedGiftId: String,
        newOwnerChatId: Long,
        starCount: Long? = null
     ...
     */
    abstract suspend fun setStickerKeywords(
        sticker: String,
     ...
     */
    abstract suspend fun createInvoiceLink(
        title: String,
        description: String,
        payload: String,
     ...
     */
    abstract suspend fun sendInvoice(
        chatId: ChatId,
        title: String,
        description: String,
        payload: String,
     ...
     */
    abstract suspend fun setMessageReaction(
        chatId: ChatId,
        messageId: Long,
     ...
     * @param replyParameters Description of the message to reply to
     */
    abstract suspend fun sendMediaGroup(
        chatId: ChatId,
     ...
     */
    abstract suspend fun promoteChatMember(
        chatId: ChatId,
        userId: Long,
        isAnonymous: Boolean? = null,
     ...
     */
    abstract suspend fun forwardMessages(
        chatId: ChatId,
        fromChatId: ChatId,
        messageIds: List<Long>,
        messageThreadId: Long? = null,
     ...
     * @param protectContent Pass True if the content of the story must be protected from forwarding and screenshotting
     */
    abstract suspend fun repostStory(
        businessConnectionId: String,
        fromChatId: Long,
        fromStoryId: Long,
        activePeriod: Long,
     ...
     * @param result A JSON-serialized object describing the message to be sent
     */
    abstract suspend fun answerWebAppQuery(
     ...
     */
    abstract suspend fun replaceStickerInSet(
        userId: Long,
        name: String,
        oldSticker: String,
     ...
     */
    abstract suspend fun answerCallbackQuery(
     ...
     */
    abstract suspend fun addStickerToSet(
        userId: Long,
        name: String,
        sticker: InputSticker
    ): TResult<Boolean> 
     ...
     */
    abstract suspend fun createNewStickerSet(
        userId: Long,
        name: String,
        title: String,
