 ...
 * @param chatId Optional. If the message to be replied to is from a different chat, unique identifier for the chat or username of the bot, supergroup or channel in the format @username. Not supported for messages sent on behalf of a business account and messages from channel direct messages chats.
 ...
 * @param pollOptionId Optional. Persistent identifier of the specific poll option to be replied to
 */
@Serializable
