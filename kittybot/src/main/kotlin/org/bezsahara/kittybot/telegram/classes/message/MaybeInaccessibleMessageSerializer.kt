    ...
    override fun deserialize(decoder: Decoder): MaybeInaccessibleMessage {
        ...
        decodeLoop@ while (true) {
            when (val index = dec.decodeElementIndex(descriptor)) {
                ...
                36 -> animation = dec.decodeNullableSerializableElement(descriptor, 36, Animation.serializer(), null)
                37 -> audio = dec.decodeNullableSerializableElement(descriptor, 37, Audio.serializer(), null)
                38 -> document = dec.decodeNullableSerializableElement(descriptor, 38, Document.serializer(), null)
                39 -> livePhoto = dec.decodeNullableSerializableElement(descriptor, 39, LivePhoto.serializer(), null)
                40 -> paidMedia = dec.decodeNullableSerializableElement(descriptor, 40, PaidMediaInfo.serializer(), null)
                41 -> photo = dec.decodeNullableSerializableElement(descriptor, 41, listSerializer1, null)
                42 -> sticker = dec.decodeNullableSerializableElement(descriptor, 42, Sticker.serializer(), null)
                43 -> story = dec.decodeNullableSerializableElement(descriptor, 43, Story.serializer(), null)
                44 -> video = dec.decodeNullableSerializableElement(descriptor, 44, Video.serializer(), null)
                45 -> videoNote = dec.decodeNullableSerializableElement(descriptor, 45, VideoNote.serializer(), null)
                46 -> voice = dec.decodeNullableSerializableElement(descriptor, 46, Voice.serializer(), null)
                47 -> caption = dec.decodeNullableSerializableElement(descriptor, 47, String.serializer(), null)
                48 -> captionEntities = dec.decodeNullableSerializableElement(descriptor, 48, listSerializer0, null)
                49 -> showCaptionAboveMedia = dec.decodeNullableSerializableElement(descriptor, 49, Boolean.serializer(), null)
                50 -> hasMediaSpoiler = dec.decodeNullableSerializableElement(descriptor, 50, Boolean.serializer(), null)
                51 -> checklist = dec.decodeNullableSerializableElement(descriptor, 51, Checklist.serializer(), null)
                52 -> contact = dec.decodeNullableSerializableElement(descriptor, 52, Contact.serializer(), null)
                53 -> dice = dec.decodeNullableSerializableElement(descriptor, 53, Dice.serializer(), null)
                54 -> game = dec.decodeNullableSerializableElement(descriptor, 54, Game.serializer(), null)
                55 -> poll = dec.decodeNullableSerializableElement(descriptor, 55, Poll.serializer(), null)
                56 -> venue = dec.decodeNullableSerializableElement(descriptor, 56, Venue.serializer(), null)
                57 -> location = dec.decodeNullableSerializableElement(descriptor, 57, Location.serializer(), null)
                58 -> newChatMembers = dec.decodeNullableSerializableElement(descriptor, 58, listSerializer2, null)
                59 -> leftChatMember = dec.decodeNullableSerializableElement(descriptor, 59, User.serializer(), null)
                60 -> chatOwnerLeft = dec.decodeNullableSerializableElement(descriptor, 60, ChatOwnerLeft.serializer(), null)
                61 -> chatOwnerChanged = dec.decodeNullableSerializableElement(descriptor, 61, ChatOwnerChanged.serializer(), null)
                62 -> newChatTitle = dec.decodeNullableSerializableElement(descriptor, 62, String.serializer(), null)
                63 -> newChatPhoto = dec.decodeNullableSerializableElement(descriptor, 63, listSerializer1, null)
                64 -> deleteChatPhoto = dec.decodeNullableSerializableElement(descriptor, 64, Boolean.serializer(), null)
                65 -> groupChatCreated = dec.decodeNullableSerializableElement(descriptor, 65, Boolean.serializer(), null)
                66 -> supergroupChatCreated = dec.decodeNullableSerializableElement(descriptor, 66, Boolean.serializer(), null)
                67 -> channelChatCreated = dec.decodeNullableSerializableElement(descriptor, 67, Boolean.serializer(), null)
                68 -> messageAutoDeleteTimerChanged = dec.decodeNullableSerializableElement(descriptor, 68, MessageAutoDeleteTimerChanged.serializer(), null)
                69 -> migrateToChatId = dec.decodeNullableSerializableElement(descriptor, 69, Long.serializer(), null)
                70 -> migrateFromChatId = dec.decodeNullableSerializableElement(descriptor, 70, Long.serializer(), null)
                71 -> pinnedMessage = dec.decodeNullableSerializableElement(descriptor, 71, MaybeInaccessibleMessage.serializer(), null)
                72 -> invoice = dec.decodeNullableSerializableElement(descriptor, 72, Invoice.serializer(), null)
                73 -> successfulPayment = dec.decodeNullableSerializableElement(descriptor, 73, SuccessfulPayment.serializer(), null)
                74 -> refundedPayment = dec.decodeNullableSerializableElement(descriptor, 74, RefundedPayment.serializer(), null)
                75 -> usersShared = dec.decodeNullableSerializableElement(descriptor, 75, UsersShared.serializer(), null)
                76 -> chatShared = dec.decodeNullableSerializableElement(descriptor, 76, ChatShared.serializer(), null)
                77 -> gift = dec.decodeNullableSerializableElement(descriptor, 77, GiftInfo.serializer(), null)
                78 -> uniqueGift = dec.decodeNullableSerializableElement(descriptor, 78, UniqueGiftInfo.serializer(), null)
                79 -> giftUpgradeSent = dec.decodeNullableSerializableElement(descriptor, 79, GiftInfo.serializer(), null)
                80 -> connectedWebsite = dec.decodeNullableSerializableElement(descriptor, 80, String.serializer(), null)
                81 -> writeAccessAllowed = dec.decodeNullableSerializableElement(descriptor, 81, WriteAccessAllowed.serializer(), null)
                82 -> passportData = dec.decodeNullableSerializableElement(descriptor, 82, PassportData.serializer(), null)
                83 -> proximityAlertTriggered = dec.decodeNullableSerializableElement(descriptor, 83, ProximityAlertTriggered.serializer(), null)
                84 -> boostAdded = dec.decodeNullableSerializableElement(descriptor, 84, ChatBoostAdded.serializer(), null)
                85 -> chatBackgroundSet = dec.decodeNullableSerializableElement(descriptor, 85, ChatBackground.serializer(), null)
                86 -> checklistTasksDone = dec.decodeNullableSerializableElement(descriptor, 86, ChecklistTasksDone.serializer(), null)
                87 -> checklistTasksAdded = dec.decodeNullableSerializableElement(descriptor, 87, ChecklistTasksAdded.serializer(), null)
                88 -> directMessagePriceChanged = dec.decodeNullableSerializableElement(descriptor, 88, DirectMessagePriceChanged.serializer(), null)
                89 -> forumTopicCreated = dec.decodeNullableSerializableElement(descriptor, 89, ForumTopicCreated.serializer(), null)
                90 -> forumTopicEdited = dec.decodeNullableSerializableElement(descriptor, 90, ForumTopicEdited.serializer(), null)
                91 -> forumTopicClosed = dec.decodeNullableSerializableElement(descriptor, 91, ForumTopicClosed.serializer(), null)
                92 -> forumTopicReopened = dec.decodeNullableSerializableElement(descriptor, 92, ForumTopicReopened.serializer(), null)
                93 -> generalForumTopicHidden = dec.decodeNullableSerializableElement(descriptor, 93, GeneralForumTopicHidden.serializer(), null)
                94 -> generalForumTopicUnhidden = dec.decodeNullableSerializableElement(descriptor, 94, GeneralForumTopicUnhidden.serializer(), null)
                95 -> giveawayCreated = dec.decodeNullableSerializableElement(descriptor, 95, GiveawayCreated.serializer(), null)
                96 -> giveaway = dec.decodeNullableSerializableElement(descriptor, 96, Giveaway.serializer(), null)
                97 -> giveawayWinners = dec.decodeNullableSerializableElement(descriptor, 97, GiveawayWinners.serializer(), null)
                98 -> giveawayCompleted = dec.decodeNullableSerializableElement(descriptor, 98, GiveawayCompleted.serializer(), null)
                99 -> managedBotCreated = dec.decodeNullableSerializableElement(descriptor, 99, ManagedBotCreated.serializer(), null)
                100 -> paidMessagePriceChanged = dec.decodeNullableSerializableElement(descriptor, 100, PaidMessagePriceChanged.serializer(), null)
                101 -> pollOptionAdded = dec.decodeNullableSerializableElement(descriptor, 101, PollOptionAdded.serializer(), null)
                102 -> pollOptionDeleted = dec.decodeNullableSerializableElement(descriptor, 102, PollOptionDeleted.serializer(), null)
                103 -> suggestedPostApproved = dec.decodeNullableSerializableElement(descriptor, 103, SuggestedPostApproved.serializer(), null)
                104 -> suggestedPostApprovalFailed = dec.decodeNullableSerializableElement(descriptor, 104, SuggestedPostApprovalFailed.serializer(), null)
                105 -> suggestedPostDeclined = dec.decodeNullableSerializableElement(descriptor, 105, SuggestedPostDeclined.serializer(), null)
                106 -> suggestedPostPaid = dec.decodeNullableSerializableElement(descriptor, 106, SuggestedPostPaid.serializer(), null)
                107 -> suggestedPostRefunded = dec.decodeNullableSerializableElement(descriptor, 107, SuggestedPostRefunded.serializer(), null)
                108 -> videoChatScheduled = dec.decodeNullableSerializableElement(descriptor, 108, VideoChatScheduled.serializer(), null)
                109 -> videoChatStarted = dec.decodeNullableSerializableElement(descriptor, 109, VideoChatStarted.serializer(), null)
                110 -> videoChatEnded = dec.decodeNullableSerializableElement(descriptor, 110, VideoChatEnded.serializer(), null)
                111 -> videoChatParticipantsInvited = dec.decodeNullableSerializableElement(descriptor, 111, VideoChatParticipantsInvited.serializer(), null)
                112 -> webAppData = dec.decodeNullableSerializableElement(descriptor, 112, WebAppData.serializer(), null)
                113 -> replyMarkup = dec.decodeNullableSerializableElement(descriptor, 113, InlineKeyboardMarkup.serializer(), null)
